        ...
        <ul class="sidebar-menu">
            ...
            @if(Gate::check('manage project'))
                <li class="{{ (Request::segment(1) == 'projects')?'active open':''}}">
                    <a class="nav-link" href="{{ route('projects.index') }}"><i class="fas fa-tasks"></i> <span>{{__('Project')}}</span></a>
                </li>
            @endif
            @if(\Auth::user()->type!='super admin')
            ...
            @if(Gate::check('manage company settings'))
                <li class="nav-item  {{ (Request::route()->getName() == 'systems.index') ? ' active' : '' }}">
                    <a class="nav-link" href="{{ route('company.setting') }}">
                        <i class="fas fa-sliders-h"></i>
                        <span class="nav-link-text">{{  __('Company Setting') }}</span>
                    </a>
                </li>
