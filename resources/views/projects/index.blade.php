    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{__('Project')}}</div>
            </div>
        </div>
        <div class="section-body">
            <h2 class="section-title section-title-custome">
                @can('create lead')
                    <a href="#" data-url="{{ route('projects.create') }}" data-ajax-popup="true" data-title="{{__('Create New Project')}}" class="btn btn-sm btn-warning create-btn">
