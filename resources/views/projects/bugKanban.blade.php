                        ...
                        <div class="d-flex justify-content-between w-100">
                            ...
                            <span class="create-btn ml-10">
                                ...
                                @can('create bug report')
                                    <a href="#" data-url="{{ route('task.bug.create',$project->id) }}" data-ajax-popup="true" data-title="{{__('Create Bug')}}" data-toggle="tooltip" data-original-title="{{__('Create Bug')}}" class="btn btn-sm btn-warning">
                                ...
                                <div class="row">
                                    <div class="custom-scroll-horizontal">
                                        @foreach($bugStatus as $status)
                                            ...
                                            @else
                                                @php  $bugs =$status->assign_bugs($project->id)  @endphp
                                            @endif
                                                            ...
                                                            <div class="lead lead-grid-view" data-id="{{$bug->id}}">
                                                                    ...
                                                                    <div class="more-action">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                @can('edit bug report')
                                                                                    <a href="#" data-url="{{ route('task.bug.edit',[$project->id,$bug->id]) }}" data-ajax-popup="true" data-title="{{__('Edit Bug Report')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}" class="dropdown-item">
                                                                                        {{__('Edit')}}
                                                                                    </a>
                                                                                @endcan

                                                                                @can('delete bug report')
                                                                                    <a class="dropdown-item" data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="document.getElementById('delete-form-{{$bug->id}}').submit();">{{__('Delete')}}</a>
                                                                ...
                                                                <div class="footer-wrap">
                                                                    <div class="date">
                                                                        ...
                                                                        <span class="pl-1"> {{ \Auth::user()->dateFormat($bug->start_date) }}</span>
                                                                    </div>
                                                                    <div class="date">
                                                                        <i class="far fa-clock"></i>
                                                                        <span class="pl-1"> {{ \Auth::user()->dateFormat($bug->due_date) }}</span>
                                                                    </div>
