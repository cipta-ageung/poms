                                    ...
                                    <ul>
                                        <li>
                                            <div class="project-highlight">
                                                ...
                                                <div class="info">
                                                    <span>{{__('Budget')}}</span>
                                                    <p class="value">{{ \Auth::user()->priceFormat($project->price) }}</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    @if(\Auth::user()->type!='client' || (\Auth::user()->type=='client' && in_array('create milestone',$perArr)))
                                        <div class="card-header-action">
                                        <a class="btn btn-primary btn-sm text-white" href="{{ asset(Storage::url('/project_files/Contoh Milestones.xls')) }}">Download Format Excel</a>
                    ...
                    <div class="card project-status">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                {{Form::submit(__('Change Status'),array('class'=>'ml-1 btn btn-primary btn-sm d-flex align-items-center'))}}
                            </div>
                            {{ Form::close() }}
                        </div>
                    </div>
