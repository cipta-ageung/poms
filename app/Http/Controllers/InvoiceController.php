...
class InvoiceController extends Controller
{
    ...
    public function printInvoice($id)
    {
        if(\Auth::user()->can('manage invoice'))
        {
            ...
            $invoicr = new Invoicr("A4", $settings['site_currency_symbol'], "en");
            ...
            //Set due date
            $invoicr->setDue(Utility::dateFormat($invoice->due_date));
            //Set from
            $invoicr->setFrom(
                array(
            ...
            //Render
            $invoicr->render(Utility::invoiceNumberFormat($invoice->id) . '.pdf', 'I');
            die;
        }
        else
        {
