...
class ProjectsController extends Controller
{
	...
	public function milestoneStoreJson(Request $request, $project_id)
    {
        $project = Projects::find($project_id);
        $request->validate(
            [
    ...
    public function fileUpload($id, Request $request)
    {
        ...
        $filemilestone = $request->file('file'); //GET FILE
        Excel::import(new MilestoneImport($file), $filemilestone); //IMPORT FILE 
    ...
    public function taskCreate($project_id)
    {
        ...
        return view('projects.taskCreate', compact('project', 'projects', 'priority', 'users', 'milestones', 'status'));
    }
    ...
    public function file_get_contents_curl($url)
    {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'audio1');
